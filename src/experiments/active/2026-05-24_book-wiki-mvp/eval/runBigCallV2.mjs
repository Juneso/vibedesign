...
3. 각 키워드에 중요도 score(0~1)를 매긴다 — 기본 신호는 등장 빈도, 여러 메모에 걸친 분포, 다른 개념 설명에 참조되는 정도, 목차·소개에서의 비중이지만, **최종 기준은 0의 판정이다**: 이 책의 방식에서 중심이 되는 개념이 높은 점수를 받는다.
...
10. (0의 통사 판정에 흡수 — 통사가 아닌 책엔 절대 순서 번호를 붙이지 마라.)
