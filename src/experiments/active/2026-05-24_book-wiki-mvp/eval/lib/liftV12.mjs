...
export const LIFT_PROMPT_VERSION = 'lift-v12.1';
...
주장의 개수 — 두 방향 모두 틀리지 마라:
- **쪼개지 마라**: 한 전개 방식의 슬롯으로 묶이는 내용은 주장 하나다. 대조의 양쪽을 두 주장으로, 인과 사슬의 단계들을 단계별 주장으로 나누지 마라. 문단당 주장은 보통 1~2개다.
- **뭉개지 마라**: 문단이 정말 별개의 개념 여럿을 병렬로 다루면 개념마다 주장을 나누고, 각 개념의 자구를 표제어로 유지하라. 병렬된 개념들을 하나의 일반 어휘로 흡수하는 것이 최악이다.
