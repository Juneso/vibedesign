export const SERIES_META = {
  ...
  // 빅콜 — "판단은 모델, 검증은 코드" 역전 (0809~). 소네트 1콜에 메모 전체를 주고 트리를 통째로 받는다. 현행 엔진은 bigcall-v3
  'hier-bigcall-넥서스':   { title: '빅콜 1·2차 · 넥서스', purpose: '소네트 1콜 재구성 — 2차(역할 어휘·중첩·대조 명시)에서 v13 100', pipelineId: 'bigcall-v3' },
  'hier-bigcall-피로사회': { title: '빅콜 1·2차 · 피로사회', purpose: '소네트 1콜 재구성 — 2차 86 (룰 최고 76 상회), 편차 원인은 블록 세울지 판단', pipelineId: 'bigcall-v3' },
  'hier-bigcall3-넥서스':  { title: '빅콜 3차 · 넥서스', purpose: '역할 블록 → thesis·why 메타 층', pipelineId: 'bigcall-v3' },
  'hier-bigcall3-피로사회':{ title: '빅콜 3차 · 피로사회', purpose: 'v3.3 습관 교정 → v3.4 최소 자기점검(11~)으로 편차 폭 18→5', pipelineId: 'bigcall-v3' },
  'hier-bigcall3-서양미술사':{ title: '빅콜 3차 · 서양미술사', purpose: '통시(시대순) 책 일반화 검증 — 3책째 스펙(0815 초안)', pipelineId: 'bigcall-v3' },
